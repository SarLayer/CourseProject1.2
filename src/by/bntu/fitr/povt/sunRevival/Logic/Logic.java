...
public class Logic {
    private static Stack<Integer> emptyNumber = new Stack<>();
    ...
    public static void addRE(int index, Decoration value) {
        int help = emptyNumber.indexOf(index);
        emptyNumber.remove(help);
        countNow = index;
        Logic.dictionary.put(index, value);
        count = maxCount - emptyNumber.size();
